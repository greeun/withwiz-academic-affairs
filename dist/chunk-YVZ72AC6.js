...
var StaffService = class {
  ...
  async list(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "sortOrder_asc")), SORT_ALLOWED, "sortOrder");
    const where = {};
    ...
    return _chunkFLXJUATIjs.buildPaginatedResult.call(void 0, items, total, page, limit);
  }
  async getById(id) {
...
var AcademicCalendarService = class {
  ...
  async listTimetables(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "createdAt_desc")), TIMETABLE_SORT_ALLOWED, "createdAt");
    const where = {};
  ...
  async listEvents(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "startDate_asc")), EVENT_SORT_ALLOWED, "startDate");
    const where = {};
...
var FaqService = class {
  ...
  async list(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "order_asc")), SORT_ALLOWED2, "order");
    const where = {};
  ...
  async getStats() {
    ...
    const byCategory = {};
    for (const g of groups) {
      byCategory[_nullishCoalesce(g.categoryId, () => ( "uncategorized"))] = g._count.id;
    }
...
var StudentService = class {
  ...
  async list(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "name_asc")), SORT_ALLOWED3, "name");
    const where = {};
...
var AttendanceService = class {
  ...
  async list(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "date_desc")), SORT_ALLOWED4, "date");
    const where = {};
...
var CounselingService = class {
  ...
  async list(params) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "date_desc")), SORT_ALLOWED5, "date");
    const where = {};
    if (params.studentId) where.studentId = params.studentId;
    if (params.type) where.type = params.type;
    if (params.status) where.status = params.status;
...
var REGISTRATION_COUNT_INCLUDE = { _count: { select: { registrations: true } } };
var AdmissionService = class {
  ...
  async listSessions(params = {}) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "date_desc")), SESSION_SORT_ALLOWED, "date");
    const where = {};
  ...
  async listRegistrations(sessionId, params = {}) {
    const page = _nullishCoalesce(params.page, () => ( DEFAULT_PAGE));
    const limit = _nullishCoalesce(params.limit, () => ( DEFAULT_LIMIT));
    const { field, order } = parseSortParam(_nullishCoalesce(params.sortBy, () => ( "createdAt_desc")), REGISTRATION_SORT_ALLOWED, "createdAt");
...
exports.DEFAULT_PAGE = DEFAULT_PAGE; exports.DEFAULT_LIMIT = DEFAULT_LIMIT; exports.parseSortParam = parseSortParam; exports.STUDENT_SUMMARY_SELECT = STUDENT_SUMMARY_SELECT; exports.StaffService = StaffService; exports.AcademicCalendarService = AcademicCalendarService; exports.FaqService = FaqService; exports.StudentService = StudentService; exports.AttendanceService = AttendanceService; exports.CounselingService = CounselingService; exports.AdmissionService = AdmissionService;
//# sourceMappingURL=chunk-YVZ72AC6.js.map